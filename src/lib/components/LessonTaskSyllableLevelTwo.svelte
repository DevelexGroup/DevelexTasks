<script lang="ts">
	...
	/**
	 * Step 0: Make syllable assignment invisible after a certain time
	...
	const processTaskLogic = async () => {
		processReadingAssignmentSyllable(); // Step 0: Read the correct syllable to the user, no need to use await here (Simultaneous)
		processHideAssignmentSyllable(); // Step 0: Hide the correct syllable after a certain time (Simultaneous)
