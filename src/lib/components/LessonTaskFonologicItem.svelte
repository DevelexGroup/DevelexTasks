<script lang="ts">
	import LessonTaskFonologicSymbol from './LessonTaskFonologicSymbol.svelte';
...
<button
	...
	{disabled}
>
	<LessonTaskFonologicSymbol {registerElement} {unregisterElement} {word} {id} {isHighlighted} />
	<div
