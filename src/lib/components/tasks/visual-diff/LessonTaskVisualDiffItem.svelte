<script lang="ts">
	import LessonTaskVisualDiffSymbol from './LessonTaskVisualDiffSymbol.svelte';
...
<button
	...
	{disabled}
>
	<LessonTaskVisualDiffSymbol {registerElement} {unregisterElement} {word} {id} {isHighlighted} />
	<div
