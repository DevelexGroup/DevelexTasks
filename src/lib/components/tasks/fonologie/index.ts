...
export function fonologieSymbolValidation(clickedIndex: number, state: TrackLevelState): TaskMistake[] | true {
...
export function fonologieStageValidation(state: TrackLevelState) : TaskMistake[] | true {
