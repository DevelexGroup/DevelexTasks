<script lang="ts">
	...
	import { id } from '$lib/components/tasks/zrakovka/levels/6/index';
	import { zrakovkaLevel6Data } from '$lib/components/tasks/zrakovka/zrakovka.data';
	...
	const data = levelPreset
		? getLevelData<ZrakovkaRawDataEntry>(levelPreset, zrakovkaLevel6Data, formatZrakovkaRawData)
		: null;
