<script lang="ts">
	...
	import { id } from '$lib/components/tasks/zrakovka/levels/4/index';
	import { zrakovkaLevel4Data } from '$lib/components/tasks/zrakovka/zrakovka.data';
	...
	const data = levelPreset
		? getLevelData<ZrakovkaRawDataEntry>(levelPreset, zrakovkaLevel4Data, formatZrakovkaRawData, excludeTags)
		: null;
