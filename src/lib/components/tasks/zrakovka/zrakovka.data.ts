...
import ZrakovkaLevel2Data from '$lib/components/tasks/zrakovka/data/level2.json';
import ZrakovkaLevel3Data from '$lib/components/tasks/zrakovka/data/level3.json';
