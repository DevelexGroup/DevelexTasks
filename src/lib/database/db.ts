...
db.version(1).stores({
	gazeSamples: '++id, child_id, session_id, task_name, stimulus_id, timestamp, eyetracker_x, eyetracker_y, aoi, mouse_x, mouse_y, events, sound_name, mistake_type, task_result',
